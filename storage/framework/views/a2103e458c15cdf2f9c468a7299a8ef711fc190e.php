<script>
    $(function() {
        ...
        $(".main-wrapper").on('click', ".modal-show--for--team-item-edit", function() {
            ...
            //
            $.post(
                "<?php echo nl2br(e(url('/o1/team/item-get'))); ?>",
                {
        ...
        $(".main-wrapper").off('click', "#submit--for--team-item-edit").on('click', "#submit--for--team-item-edit", function() {
            ...
            var options = {
                url: "<?php echo nl2br(e(url('/o1/team/item-save'))); ?>",
                type: "post",
                dataType: "json",
                // target: "#div2",
                // clearForm: true,
        ...
        $(".main-wrapper").off('click', ".team--item-delete-submit").on('click', ".team--item-delete-submit", function() {
            ...
            layer.msg('确定"删除"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "<?php echo nl2br(e(url('/o1/team/item-delete'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        $(".main-wrapper").off('click', ".team--item-restore-submit").on('click', ".team--item-restore-submit", function() {
            ...
            layer.msg('确定"恢复"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "<?php echo nl2br(e(url('/o1/team/item-restore'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        $(".main-wrapper").off('click', ".team--item-delete-permanently-submit").on('click', ".team--item-delete-permanently-submit", function() {
            ...
            layer.msg('确定"永久删除"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "<?php echo nl2br(e(url('/o1/team/item-delete-permanently'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        $(".main-wrapper").off('click', ".team--item-enable-submit").on('click', ".team--item-enable-submit", function() {
            ...
            layer.msg('确定"启用"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "<?php echo nl2br(e(url('/o1/team/item-enable'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        $(".main-wrapper").off('click', ".team--item-disable-submit").on('click', ".team--item-disable-submit", function() {
            ...
            layer.msg('确定"禁用"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "<?php echo nl2br(e(url('/o1/team/item-disable'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
