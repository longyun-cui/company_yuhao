<script>
    $(function() {
        ...
        $(".main-wrapper").on('click', ".modal-show--for--project-item-edit", function() {
            ...
            //
            $.post(
                "<?php echo nl2br(e(url('/o1/project/item-get'))); ?>",
                {
        ...
        $(".main-wrapper").off('click', "#submit--for--project-item-edit").on('click', "#submit--for--project-item-edit", function() {
            ...
            var options = {
                url: "<?php echo nl2br(e(url('/o1/project/item-save'))); ?>",
                type: "post",
                dataType: "json",
                // target: "#div2",
                // clearForm: true,
        ...
        $(".main-wrapper").off('click', ".project--item-delete-submit").on('click', ".project--item-delete-submit", function() {
            ...
            layer.msg('确定"删除"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "<?php echo nl2br(e(url('/o1/project/item-delete'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        $(".main-wrapper").off('click', ".project--item-restore-submit").on('click', ".project--item-restore-submit", function() {
            ...
            layer.msg('确定"恢复"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "<?php echo nl2br(e(url('/o1/project/item-restore'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        $(".main-wrapper").off('click', ".project--item-delete-permanently-submit").on('click', ".project--item-delete-permanently-submit", function() {
            ...
            layer.msg('确定"永久删除"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "<?php echo nl2br(e(url('/o1/project/item-delete-permanently'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        $(".main-wrapper").off('click', ".project--item-enable-submit").on('click', ".project--item-enable-submit", function() {
            ...
            layer.msg('确定"启用"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "<?php echo nl2br(e(url('/o1/project/item-enable'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        $(".main-wrapper").off('click', ".project--item-disable-submit").on('click', ".project--item-disable-submit", function() {
            ...
            layer.msg('确定"禁用"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "<?php echo nl2br(e(url('/o1/project/item-disable'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
