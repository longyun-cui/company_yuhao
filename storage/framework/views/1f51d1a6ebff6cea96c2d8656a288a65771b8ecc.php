...
//                "scrollY": true,
            ...
            "showRefresh": true,
            "ajax": {
                'url': "<?php echo nl2br(e(url('/o1/order/order-duplicate-list/datatable-query'))); ?>",
                "type": 'POST',
                "dataType" : 'json',
                "data": function (d) {
            ...
            "fixedColumns": {
                ...
                <?php if($me->department_district_id == 0): ?>
                "leftColumns": "<?php if($is_mobile_equipment): ?> 1 <?php else: ?> 6 <?php endif; ?>",
                "rightColumns": "<?php if($is_mobile_equipment): ?> 0 <?php else: ?> 1 <?php endif; ?>",
                <?php else: ?>
                "leftColumns": "<?php if($is_mobile_equipment): ?> 1 <?php else: ?> 4 <?php endif; ?>",
                "rightColumns": "<?php if($is_mobile_equipment): ?> 0 <?php else: ?> 1 <?php endif; ?>",
                <?php endif; ?>
