                    ...
                    <li class="">
                        <div class="col-md-12 datatable-search-row filter-box">
                            <div class="pull-right">
                                ...
                                <input type="text" class="search-filter form-filter filter-keyup date-picker-c" name="order-export--date" placeholder="选择日期" readonly="readonly" value="<?php echo nl2br(e(date('Y-m-d'))); ?>" data-default="<?php echo nl2br(e(date('Y-m-d'))); ?>" />
                                ...
                                <input type="text" class="search-filter form-filter filter-keyup month-picker month-picker-c" name="order-export--month" placeholder="选择月份" readonly="readonly" value="<?php echo nl2br(e(date('Y-m'))); ?>" data-default="<?php echo nl2br(e(date('Y-m'))); ?>" />
                                ...
                                <input type="text" class="search-filter form-filter filter-keyup date-picker-c" name="order-export--start" placeholder="起始时间" readonly="readonly" value="<?php echo nl2br(e(date('Y-m-d'))); ?>" data-default="<?php echo nl2br(e(date('Y-m-d'))); ?>" style="width:120px;text-align:center;" />
                                <input type="text" class="search-filter form-filter filter-keyup date-picker-c" name="order-export--ended" placeholder="结束时间" readonly="readonly" value="<?php echo nl2br(e(date('Y-m-d'))); ?>" data-default="<?php echo nl2br(e(date('Y-m-d'))); ?>" style="width:120px;text-align:center;" />
    ...
    <div class="col-md-12 datatable-search-row datatable-search-box">
        <div class="pull-right">
            ...
            <select class="search-filter form-filter filter-lg select2-box-c select2-staff-c-" name="export-record--staff">
                ...
                <?php $__currentLoopData = $staff_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo nl2br(e($v->id)); ?>"><?php echo nl2br(e($v->name)); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php endif; ?>
            </select>
