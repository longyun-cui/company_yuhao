<script>
    ...
    $(function() {
        ...
        $("#edit-item-submit").on('click', function() {
            var options = {
                url: "<?php echo nl2br(e(url('/item/order-edit'))); ?>",
                type: "post",
                dataType: "json",
                // target: "#div2",
                success: function (data) {
                    ...
                    else
                    {
                        ...
                        else location.href = "<?php echo nl2br(e(url('/item/order-list-for-all'))); ?>";
                        // history.go(-1);
                    }
                }
            };
...
//            }
        ...
        $('#order-edit-select2-client').select2({
            ajax: {
                url: "<?php echo nl2br(e(url('/v1/operate/select2/select2-client'))); ?>",
                type: 'post',
                dataType: 'json',
                delay: 250,
        ...
        $('#order-edit-select2-project').select2({
            ajax: {
                url: "<?php echo nl2br(e(url('/v1/operate/select2/select2-project'))); ?>",
                type: 'post',
                dataType: 'json',
                delay: 250,
                data: function (params) {
        ...
        $('#select2-route').select2({
            ajax: {
                url: "<?php echo nl2br(e(url('/item/order_select2_route'))); ?>",
                dataType: 'json',
                delay: 250,
                data: function (params) {
                    return {
...
//                    });
        ...
        $('#select2-driver').select2({
            ajax: {
                url: "<?php echo nl2br(e(url('/item/order_select2_driver'))); ?>",
                dataType: 'json',
                delay: 250,
                data: function (params) {
                    return {
        ...
        $('.order-edit-select2-driver').select2({
            ajax: {
                url: "<?php echo nl2br(e(url('/v1/operate/select2/select2-driver'))); ?>",
                type: 'post',
                dataType: 'json',
                delay: 250,
                data: function (params) {
