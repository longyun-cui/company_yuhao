<script>
    $(function() {
        ...
        $(".main-wrapper").off('click', ".item-enable-submit").on('click', ".item-enable-submit", function() {
            ...
            layer.msg('确定"启用"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "<?php echo nl2br(e(url('/v1/operate/universal/item-enable'))); ?>",
                        {
        ...
        $(".main-wrapper").off('click', ".item-disable-submit").on('click', ".item-disable-submit", function() {
            ...
            layer.msg('确定"禁用"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "<?php echo nl2br(e(url('/v1/operate/universal/item-disable'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        $(".main-wrapper").off('click', ".item-password-reset-submit").on('click', ".item-password-reset-submit", function() {
            ...
            layer.msg('确定"重置密码"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "<?php echo nl2br(e(url('/v1/operate/universal/password-reset-by-admin'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        $(".main-wrapper").off('click', ".item-login-submit").on('click', ".item-login-submit", function() {
            ...
            //
            $.post(
                "<?php echo nl2br(e(url('/v1/operate/universal/item-login-by-admin'))); ?>",
                {
                    _token: $('meta[name="_token"]').attr('content'),
                ...
                .done(function($response, status, jqXHR) {
                    ...
                    else
                    {
                        ...
                        if($item_category == 'staff')
                        {
                            ...
                            temp_window.location = "<?php echo nl2br(e(env('DOMAIN_DK_ADMIN'))); ?>/";
                        }
                        else if($item_category == 'company')
                        {
                            var temp_window=window.open();
                            temp_window.location = "<?php echo nl2br(e(env('DOMAIN_DK_AGENCY'))); ?>/";
                        }
                        else if($item_category == 'client')
                        {
                            var temp_window=window.open();
                            temp_window.location = "<?php echo nl2br(e(env('DOMAIN_DK_CLIENT'))); ?>/";
                        }
                    }
                })
                .fail(function(jqXHR, status, error) {
        ...
        $(".main-wrapper").off('click', ".item-delete-submit").on('click', ".item-delete-submit", function() {
            ...
            layer.msg('确定"删除"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "<?php echo nl2br(e(url('/v1/operate/universal/item-delete-by-admin'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        $(".main-wrapper").off('click', ".item-restore-submit").on('click', ".item-restore-submit", function() {
            ...
            layer.msg('确定"恢复"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "<?php echo nl2br(e(url('/v1/operate/universal/item-restore-by-admin'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        $(".main-wrapper").off('click', ".item-delete-permanently-submit").on('click', ".item-delete-permanently-submit", function() {
            ...
            layer.msg('确定"永久删除"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "<?php echo nl2br(e(url('/item/item-delete-permanently-by-admin'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        $(".main-wrapper").off('click', ".item-promote-submit").on('click', ".item-promote-submit", function() {
            ...
            layer.msg('确定"晋升"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "<?php echo nl2br(e(url('/v1/operate/universal/item-promote-by-admin'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        $(".main-wrapper").off('click', ".item-demote-submit").on('click', ".item-demote-submit", function() {
            ...
            layer.msg('确定"降职"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "<?php echo nl2br(e(url('/v1/operate/universal/item-demote-by-admin'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
