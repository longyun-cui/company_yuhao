<script>
    $(function() {
        ...
        // 【车辆】导入-显示
        $(".main-wrapper").on('click', ".modal-show--for--car-import", function() {
            var $that = $(this);
        ...
        // 【车辆】导入-提交
        $(".main-wrapper").on('click', "#submit--for--car--import--by-excel", function() {
            var $that = $(this);

            var $table_id = $that.data('datatable-list-id');
            var $table = $('#'+$table_id);

            var $modal_id = 'modal--for--car--import--by-excel';
            var $modal = $("#"+$modal_id);

            var $form_id = 'form--for--car--import--by-excel';
            var $form = $("#"+$form_id);
            ...
            var options = {
                url: "<?php echo nl2br(e(url('/o1/car/import--save'))); ?>",
                type: "post",
                dataType: "json",
                // target: "#div2",
                // clearForm: true,
            ...
            $.post(
                ...
                .done(function($response, status, jqXHR) {
                    ...
                    else
                    {
                        ...
                        $modal.find('input[name="car_name"]').val($response.data.car_name);
        ...
        $(".main-wrapper").off('click', "#submit--for--car--item-edit").on('click', "#submit--for--car--item-edit", function() {
            ...
            var options = {
                url: "<?php echo nl2br(e(url('/o1/car/item-save'))); ?>",
                type: "post",
                dataType: "json",
                // target: "#div2",
                // clearForm: true,
        ...
        $(".main-wrapper").off('click', ".car--item-delete-submit").on('click', ".car--item-delete-submit", function() {
            ...
            layer.msg('确定"删除"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "<?php echo nl2br(e(url('/o1/car/item-delete'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        $(".main-wrapper").off('click', ".car--item-restore-submit").on('click', ".car--item-restore-submit", function() {
            ...
            layer.msg('确定"恢复"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "<?php echo nl2br(e(url('/o1/car/item-restore'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        $(".main-wrapper").off('click', ".car--item-delete-permanently-submit").on('click', ".car--item-delete-permanently-submit", function() {
            ...
            layer.msg('确定"永久删除"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "<?php echo nl2br(e(url('/o1/car/item-delete-permanently'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        $(".main-wrapper").off('click', ".car--item-enable-submit").on('click', ".car--item-enable-submit", function() {
            ...
            layer.msg('确定"启用"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "<?php echo nl2br(e(url('/o1/car/item-enable'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        $(".main-wrapper").off('click', ".car--item-disable-submit").on('click', ".car--item-disable-submit", function() {
            ...
            layer.msg('确定"禁用"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "<?php echo nl2br(e(url('/o1/car/item-disable'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        // 【车辆】禁用
        $(".main-wrapper").off('click', ".car--batch--api-location-update").on('click', ".car--batch--api-location-update", function() {
            var $that = $(this);
            var $datatable_wrapper = $that.closest('.datatable-wrapper');
            var $table_id = $datatable_wrapper.find('table').filter('[id][id!=""]').attr("id");
            ...
            layer.msg('确定"更新"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "<?php echo nl2br(e(url('/o1/car/batch-api-location-update'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: "car--batch--api-location-update"
                        },
                        'json'
                    )
                        .done(function($response, status, jqXHR) {
