<script>
    ...
    function Datatable_Statistic_of_Driver_by_Daily_for_Order($tableId, $eChartId)
    {
        let $that = $($tableId);
        ...
        $($tableId).DataTable({
            ...
            "orderCellsTop": true,
            "ajax": {
                'url': "<?php echo nl2br(e(url('/v1/operate/statistic/statistic-driver-by-daily-for-order'))); ?>",
                "type": 'POST',
                "dataType" : 'json',
                "data": function (d) {
                    d._token = $('meta[name="_token"]').attr('content');
                    d.driver_id = $tableSearch.find('input[name="statistic-driver-by-daily-driver-id"]').val();
                    d.id = $tableSearch.find('input[name="statistic-driver-by-daily-id"]').val();
                    d.name = $tableSearch.find('input[name="statistic-driver-by-daily-name"]').val();
                    d.title = $tableSearch.find('input[name="statistic-driver-by-daily-title"]').val();
                    d.keyword = $tableSearch.find('input[name="statistic-driver-by-daily-keyword"]').val();
                    d.status = $tableSearch.find('select[name="statistic-driver-by-daily-status"]').val();
                    d.time_type = $tableSearch.find('input[name="statistic-driver-by-daily-time-type"]').val();
                    d.time_month = $tableSearch.find('input[name="statistic-driver-by-daily-month"]').val();
                    d.time_date = $tableSearch.find('input[name="statistic-driver-by-daily-date"]').val();
                    d.date_start = $tableSearch.find('input[name="statistic-driver-by-daily-start"]').val();
                    d.date_ended = $tableSearch.find('input[name="statistic-driver-by-daily-ended"]').val();
                },
            },
            // "fixedColumns": {
