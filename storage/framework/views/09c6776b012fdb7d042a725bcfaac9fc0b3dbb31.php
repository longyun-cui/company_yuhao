<div class="row datatable-body datatable-wrapper car--statistic--task-amount--clone" data-datatable-item-category="car--statistic--task-amount">
    ...
    <div class="col-md-12 datatable-search-row  datatable-search-box">
        ...
        <div class="pull-right">
            ...
            <input type="text" class="search-filter form-filter filter-keyup date-picker-c" name="car--statistic--task-amount-date" placeholder="选择日期" readonly="readonly" value="<?php echo nl2br(e(date('Y-m-d'))); ?>" data-default="<?php echo nl2br(e(date('Y-m-d'))); ?>" />
            ...
            <input type="text" class="search-filter form-filter filter-keyup month_picker" name="car--statistic--task-amount-month" placeholder="选择月份" readonly="readonly" value="<?php echo nl2br(e(date('Y-m'))); ?>" data-default="<?php echo nl2br(e(date('Y-m'))); ?>" />
            ...
            <input type="text" class="search-filter filter-keyup date_picker" name="car--statistic--task-amount-start" placeholder="起始时间" readonly="readonly" value="<?php echo nl2br(e(date('Y-m-d'))); ?>" data-default="<?php echo nl2br(e(date('Y-m-d'))); ?>" style="margin-right:-3px;" />
            <input type="text" class="search-filter filter-keyup date_picker" name="car--statistic--task-amount-ended" placeholder="终止时间" readonly="readonly" value="<?php echo nl2br(e(date('Y-m-d'))); ?>" data-default="<?php echo nl2br(e(date('Y-m-d'))); ?>" />
