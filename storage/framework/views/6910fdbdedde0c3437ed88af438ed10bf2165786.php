<script>
    ...
    function Datatable_Statistic_of_Client_by_Daily_for_Order($tableId, $eChartId)
    {
        let $that = $($tableId);
        ...
        $($tableId).DataTable({
            ...
            "orderCellsTop": true,
            "ajax": {
                'url': "<?php echo nl2br(e(url('/v1/operate/statistic/statistic-client-by-daily-for-order'))); ?>",
                "type": 'POST',
                "dataType" : 'json',
                "data": function (d) {
                    d._token = $('meta[name="_token"]').attr('content');
                    d.client_id = $tableSearch.find('input[name="statistic-client-by-daily-client-id"]').val();
                    d.id = $tableSearch.find('input[name="statistic-client-by-daily-id"]').val();
                    d.name = $tableSearch.find('input[name="statistic-client-by-daily-name"]').val();
                    d.title = $tableSearch.find('input[name="statistic-client-by-daily-title"]').val();
                    d.keyword = $tableSearch.find('input[name="statistic-client-by-daily-keyword"]').val();
                    d.status = $tableSearch.find('select[name="statistic-client-by-daily-status"]').val();
                    d.time_type = $tableSearch.find('input[name="statistic-client-by-daily-time-type"]').val();
                    d.time_month = $tableSearch.find('input[name="statistic-client-by-daily-month"]').val();
                    d.time_date = $tableSearch.find('input[name="statistic-client-by-daily-date"]').val();
                    d.date_start = $tableSearch.find('input[name="statistic-client-by-daily-start"]').val();
                    d.date_ended = $tableSearch.find('input[name="statistic-client-by-daily-ended"]').val();
                },
            },
            // "fixedColumns": {
