    ...
    <div class="col-md-12 datatable-search-row  datatable-search-box">
        ...
        <div class="pull-right">
            ...
            <select class="search-filter form-filter filter-md select2-box-c" name="staff-type">
                ...
                <option value="88">业务员</option>
                <option value="81">业务经理</option>
                <option value="81">业务总监</option>
                <option value="77">财务人员</option>
                <option value="71">财务经理</option>
                <option value="71">财务总监</option>
            </select>
            <?php endif; ?>
