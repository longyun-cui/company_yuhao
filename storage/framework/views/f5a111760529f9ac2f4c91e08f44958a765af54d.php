<div class="row datatable-body datatable-wrapper statistic-order-daily-clone" data-datatable-item-category="statistic-order-daily">
    ...
    <div class="col-md-12 datatable-search-row  datatable-search-box">
        ...
        <div class="pull-right">
            ...
            <input type="text" class="search-filter form-filter filter-keyup month_picker" name="statistic-order-daily-month" placeholder="选择月份" readonly="readonly" value="<?php echo nl2br(e(date('Y-m'))); ?>" data-default="<?php echo nl2br(e(date('Y-m'))); ?>" />
