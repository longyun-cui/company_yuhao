<script>
    ...
    function Datatable_Statistic_of_Project_by_Daily_for_Order($tableId, $eChartId)
    {
        let $that = $($tableId);
        ...
        $($tableId).DataTable({
            ...
            "orderCellsTop": true,
            "ajax": {
                'url': "<?php echo nl2br(e(url('/v1/operate/statistic/statistic-project-by-daily-for-order'))); ?>",
                "type": 'POST',
                "dataType" : 'json',
                "data": function (d) {
