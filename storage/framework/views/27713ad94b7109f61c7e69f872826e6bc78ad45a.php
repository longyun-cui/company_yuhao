<script>
    $(function() {
        ...
        $(".main-wrapper").on('click', ".company-edit-show", function() {
            ...
            //
            $.post(
                "<?php echo nl2br(e(url('/v1/operate/company/item-get'))); ?>",
                {
        ...
        $(".main-wrapper").on('click', "#edit-submit-for-company", function() {
            ...
            var options = {
                url: "<?php echo nl2br(e(url('/v1/operate/company/item-save'))); ?>",
                type: "post",
                dataType: "json",
                // target: "#div2",
                // clearForm: true,
        ...
        $(".main-wrapper").on('click', ".department-edit-show", function() {
            ...
            //
            $.post(
                "<?php echo nl2br(e(url('/v1/operate/department/item-get'))); ?>",
                {
                    _token: $('meta[name="_token"]').attr('content'),
                    operate: "item-get",
                    item_type: "department",
        ...
        $(".main-wrapper").on('click', "#edit-submit-for-department", function() {
            ...
            var options = {
                url: "<?php echo nl2br(e(url('/v1/operate/department/item-save'))); ?>",
                type: "post",
                dataType: "json",
                // target: "#div2",
                // clearForm: true,
        ...
        $(".main-wrapper").on('click', ".team-edit-show", function() {
            ...
            //
            $.post(
                "<?php echo nl2br(e(url('/v1/operate/team/item-get'))); ?>",
                {
                    _token: $('meta[name="_token"]').attr('content'),
                    operate: "item-get",
                    item_type: "team",
        ...
        $(".main-wrapper").on('click', "#edit-submit-for-team", function() {
            ...
            var options = {
                url: "<?php echo nl2br(e(url('/v1/operate/team/item-save'))); ?>",
                type: "post",
                dataType: "json",
                // target: "#div2",
                // clearForm: true,
        ...
        $(".main-wrapper").on('click', ".staff-edit-show", function() {
            ...
            //
            $.post(
                "<?php echo nl2br(e(url('/v1/operate/staff/item-get'))); ?>",
                {
                    _token: $('meta[name="_token"]').attr('content'),
                    operate: "item-get",
                    item_type: "department",
        ...
        $(".main-wrapper").on('click', "#edit-submit-for-staff", function() {
            ...
            var options = {
                url: "<?php echo nl2br(e(url('/v1/operate/staff/item-save'))); ?>",
                type: "post",
                dataType: "json",
                // target: "#div2",
                // clearForm: true,
        ...
        $(".main-wrapper").on('click', ".car-edit-show", function() {
            ...
            //
            $.post(
                "<?php echo nl2br(e(url('/v1/operate/car/item-get'))); ?>",
                {
                    _token: $('meta[name="_token"]').attr('content'),
                    operate: "item-get",
                    item_type: "car",
        ...
        $(".main-wrapper").on('click', "#edit-submit-for-car", function() {
            ...
            var options = {
                url: "<?php echo nl2br(e(url('/v1/operate/location/item-save'))); ?>",
                type: "post",
                dataType: "json",
                // target: "#div2",
                // clearForm: true,
        ...
        $(".main-wrapper").on('click', ".driver-edit-show", function() {
            ...
            //
            $.post(
                "<?php echo nl2br(e(url('/v1/operate/driver/item-get'))); ?>",
                {
                    _token: $('meta[name="_token"]').attr('content'),
                    operate: "item-get",
                    item_type: "driver",
        ...
        $(".main-wrapper").on('click', "#edit-submit-for-driver", function() {
            ...
            var options = {
                url: "<?php echo nl2br(e(url('/v1/operate/driver/item-save'))); ?>",
                type: "post",
                dataType: "json",
                // target: "#div2",
                // clearForm: true,
        ...
        $(".main-wrapper").on('click', ".client-edit-show", function() {
            ...
            //
            $.post(
                "<?php echo nl2br(e(url('/v1/operate/client/item-get'))); ?>",
                {
                    _token: $('meta[name="_token"]').attr('content'),
                    operate: "item-get",
                    item_type: "client",
        ...
        $(".main-wrapper").on('click', "#edit-submit-for-client", function() {
            ...
            var options = {
                url: "<?php echo nl2br(e(url('/v1/operate/client/item-save'))); ?>",
                type: "post",
                dataType: "json",
                // target: "#div2",
                // clearForm: true,
        ...
        $(".main-wrapper").on('click', ".project-edit-show", function() {
            ...
            //
            $.post(
                "<?php echo nl2br(e(url('/v1/operate/project/item-get'))); ?>",
                {
                    _token: $('meta[name="_token"]').attr('content'),
                    operate: "item-get",
                    item_type: "project",
        ...
        $(".main-wrapper").on('click', "#edit-submit-for-project", function() {
            ...
            var options = {
                url: "<?php echo nl2br(e(url('/v1/operate/project/item-save'))); ?>",
                type: "post",
                dataType: "json",
                // target: "#div2",
                // clearForm: true,
        ...
        $(".main-wrapper").on('click', ".location-edit-show", function() {
            ...
            //
            $.post(
                "<?php echo nl2br(e(url('/v1/operate/location/item-get'))); ?>",
                {
                    _token: $('meta[name="_token"]').attr('content'),
                    operate: "item-get",
                    item_type: "location",
        ...
        $(".main-wrapper").on('click', ".order-edit-show", function() {
            ...
            //
            $.post(
                "<?php echo nl2br(e(url('/v1/operate/order/item-get'))); ?>",
                {
                    _token: $('meta[name="_token"]').attr('content'),
                    operate: "item-get",
                    item_type: "order",
        ...
        $(".main-wrapper").on('click', "#edit-submit-for-order", function() {
            ...
            var options = {
                url: "<?php echo nl2br(e(url('/v1/operate/order/item-save'))); ?>",
                type: "post",
                dataType: "json",
                // target: "#div2",
                // clearForm: true,
        ...
        $(".main-wrapper").on('click', "#edit-submit-for-field-set", function() {
            ...
            //
            var options = {
                url: "<?php echo nl2br(e(url('/v1/operate/universal/field-set'))); ?>",
                type: "post",
                dataType: "json",
                // target: "#div2",
                // clearForm: true,
        ...
        $(".main-wrapper").on('dblclick', ".modal-show-for-phone-pool-info", function() {
            ...
            //
            $.post(
                "<?php echo nl2br(e(url('/v1/operate/order/item-get-phone-pool-info'))); ?>",
                {
                    _token: $('meta[name="_token"]').attr('content'),
                    operate: "item-get",
                    phone: $phone,
