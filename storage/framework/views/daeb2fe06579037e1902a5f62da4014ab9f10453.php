<div class="row datatable-body datatable-wrapper motorcade-list-clone" data-datatable-item-category="motorcade" data-item-name="车队">
    ...
    <div class="col-md-12 datatable-search-row  datatable-search-box">
        ...
        <div class=" pull-left">
            ...
            <?php if(in_array($me->user_type,[0,1,9,11,19])): ?>
            <button type="button" onclick="" class="btn btn-filter btn-success- modal-show--for--motorcade-item-create"
                    data-form-id="form--for--motorcade-item-edit"
                    data-modal-id="modal--for--motorcade-item-edit"
                    data-title="添加车队"
            >
        ...
        <div class="pull-right">
            ...
            <input type="text" class="search-filter form-filter filter-keyup" name="motorcade-id" placeholder="ID" />

            <input type="text" class="search-filter form-filter filter-keyup" name="motorcade-name" placeholder="名称" />

            <select class="search-filter form-filter select2-box-c" name="motorcade-type">
                <option value ="-1">全部</option>
                <option value ="11">大区</option>
                <option value ="21">小组</option>
            </select>

            <select class="search-filter form-filter select2-box-c" name="motorcade-status">
                <option value ="-1">全部</option>
