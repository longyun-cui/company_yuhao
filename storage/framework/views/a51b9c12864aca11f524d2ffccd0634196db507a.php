<script>
    $(function() {
        ...
        // 【公司】添加-显示
        $(".main-wrapper").on('click', ".modal-show--for--company-item-create", function() {
            var $that = $(this);
        ...
        // 【公司】编辑-显示
        $(".main-wrapper").on('click', ".modal-show--for--company-item-edit", function() {
            var $that = $(this);
            ...
            //
            $.post(
                "<?php echo nl2br(e(url('/o1/company/item-get'))); ?>",
                {
                ...
                .done(function($response, status, jqXHR) {
                    ...
                    else
                    {
                        ...
                        form_reset('#modal--for--company-item-edit');

                        var $modal = $('#modal--for--company-item-edit');
        ...
        $(".main-wrapper").off('click', "#submit--for--company-item-edit").on('click', "#submit--for--company-item-edit", function() {
            ...
            var $modal_id = 'modal--for--company-item-edit';
            var $modal = $("#"+$modal_id);

            var $form_id = 'form--for--company-item-edit';
            var $form = $("#"+$form_id);
            ...
            var options = {
                url: "<?php echo nl2br(e(url('/o1/company/item-save'))); ?>",
                type: "post",
                dataType: "json",
                // target: "#div2",
                // clearForm: true,
        ...
        // 【公司】删除
        $(".main-wrapper").off('click', ".company--item-delete-submit").on('click', ".company--item-delete-submit", function() {
            var $that = $(this);
            ...
            layer.msg('确定"删除"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "<?php echo nl2br(e(url('/o1/company/item-delete'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: "company--item-delete",
        ...
        // 【公司】恢复
        $(".main-wrapper").off('click', ".company--item-restore-submit").on('click', ".company--item-restore-submit", function() {
            var $that = $(this);
            var $id = $that.attr('data-id');
            var $row = $that.parents('tr');
            var $datatable_wrapper = $that.closest('.datatable-wrapper');
            ...
            layer.msg('确定"恢复"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "<?php echo nl2br(e(url('/o1/company/item-restore'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: "company--item-restore",
                            item_category: $item_category,
                            item_id: $that.attr('data-id')
                        },
                        'json'
        ...
        // 【公司】永久删除
        $(".main-wrapper").off('click', ".company--item-delete-permanently-submit").on('click', ".company--item-delete-permanently-submit", function() {
            var $that = $(this);
            var $id = $that.attr('data-id');
            var $row = $that.parents('tr');
            var $datatable_wrapper = $that.closest('.datatable-wrapper');
            ...
            layer.msg('确定"永久删除"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "<?php echo nl2br(e(url('/o1/company/item-delete-permanently'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: "company--item-delete-permanently",
                            item_category: $item_category,
                            item_id: $that.attr('data-id')
                        },
                        'json'
        ...
        // 【公司】启用
        $(".main-wrapper").off('click', ".company--item-enable-submit").on('click', ".company--item-enable-submit", function() {
            var $that = $(this);
            var $id = $that.attr('data-id');
            var $row = $that.parents('tr');
            var $datatable_wrapper = $that.closest('.datatable-wrapper');
            ...
            layer.msg('确定"启用"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "<?php echo nl2br(e(url('/o1/company/item-enable'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: "company--item-enable",
                            item_category: $item_category,
                            item_id: $that.attr('data-id')
                        },
                        'json'
        ...
        // 【公司】禁用
        $(".main-wrapper").off('click', ".company--item-disable-submit").on('click', ".company--item-disable-submit", function() {
            var $that = $(this);
            var $id = $that.attr('data-id');
            var $row = $that.parents('tr');
            var $datatable_wrapper = $that.closest('.datatable-wrapper');
            ...
            layer.msg('确定"禁用"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "<?php echo nl2br(e(url('/o1/company/item-disable'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: "company--item-disable",
                            item_category: $item_category,
                            item_id: $that.attr('data-id')
                        },
                        'json'
        ...
        // 【公司】操作记录
        $(".main-content").off('click', ".modal-show--for--company--item-operation-record").on('click', ".modal-show--for--company--item-operation-record", function() {
            var $that = $(this);
            var $id = $(this).data('id');
            var $row = $that.parents('tr');
            var $datatable_wrapper = $that.closest('.datatable-wrapper');
            ...
            var $modal = $('#modal--for--company-item-operation-record-list');
