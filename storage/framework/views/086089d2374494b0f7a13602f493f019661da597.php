<div class="row datatable-body datatable-wrapper company-list-clone" data-datatable-item-category="company" data-item-name="公司">
    ...
    <div class="col-md-12 datatable-search-row  datatable-search-box">
        ...
        <div class=" pull-left">
            ...
            <button type="button" onclick="" class="btn btn-filter btn-success- modal-show--for--company-item-create"
                    data-form-id="form--for--company-item-edit"
                    data-modal-id="modal--for--company-item-edit"
                    data-title="添加公司"
            >
        ...
        <div class="pull-right">
            ...
            <input type="text" class="search-filter form-filter filter-keyup" name="company-name" placeholder="名称" />

            <select class="search-filter form-filter select2-box-c" name="company-type">
                <option value ="-1">全部</option>
                <option value ="11">大区</option>
                <option value ="21">小组</option>
            </select>

            <select class="search-filter form-filter select2-box-c" name="company-status">
                <option value ="-1">全部</option>
