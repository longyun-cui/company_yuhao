<script>
    $(function() {
        ...
        // 【车辆】导入-显示
        $(".main-wrapper").on('click', ".modal-show--for--driver-import", function() {
            var $that = $(this);
        ...
        // 【车辆】导入-提交
        $(".main-wrapper").on('click', "#submit--for--driver--import--by-excel", function() {
            var $that = $(this);

            var $table_id = $that.data('datatable-list-id');
            var $table = $('#'+$table_id);

            var $modal_id = 'modal--for--driver--import--by-excel';
            var $modal = $("#"+$modal_id);

            var $form_id = 'form--for--driver--import--by-excel';
            var $form = $("#"+$form_id);
            ...
            var options = {
                url: "<?php echo nl2br(e(url('/o1/driver/import--save'))); ?>",
                type: "post",
                dataType: "json",
                // target: "#div2",
                // clearForm: true,
        ...
        $(".main-wrapper").on('click', ".modal-show--for--driver-item-edit", function() {
            ...
            //
            $.post(
                "<?php echo nl2br(e(url('/o1/driver/item-get'))); ?>",
                {
        ...
        $(".main-wrapper").off('click', "#submit--for--driver-item-edit").on('click', "#submit--for--driver-item-edit", function() {
            ...
            var options = {
                url: "<?php echo nl2br(e(url('/o1/driver/item-save'))); ?>",
                type: "post",
                dataType: "json",
                // target: "#div2",
                // clearForm: true,
        ...
        $(".main-wrapper").off('click', ".driver--item-delete-submit").on('click', ".driver--item-delete-submit", function() {
            ...
            layer.msg('确定"删除"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "<?php echo nl2br(e(url('/o1/driver/item-delete'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        $(".main-wrapper").off('click', ".driver--item-restore-submit").on('click', ".driver--item-restore-submit", function() {
            ...
            layer.msg('确定"恢复"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "<?php echo nl2br(e(url('/o1/driver/item-restore'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        $(".main-wrapper").off('click', ".driver--item-delete-permanently-submit").on('click', ".driver--item-delete-permanently-submit", function() {
            ...
            layer.msg('确定"永久删除"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "<?php echo nl2br(e(url('/o1/driver/item-delete-permanently'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        $(".main-wrapper").off('click', ".driver--item-enable-submit").on('click', ".driver--item-enable-submit", function() {
            ...
            layer.msg('确定"启用"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "<?php echo nl2br(e(url('/o1/driver/item-enable'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        $(".main-wrapper").off('click', ".driver--item-disable-submit").on('click', ".driver--item-disable-submit", function() {
            ...
            layer.msg('确定"禁用"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "<?php echo nl2br(e(url('/o1/driver/item-disable'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
