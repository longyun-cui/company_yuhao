<script>
    $(function() {
        ...
        $(".main-wrapper").on('click', ".modal-show--for--staff-item-edit", function() {
            ...
            //
            $.post(
                "<?php echo nl2br(e(url('/o1/staff/item-get'))); ?>",
                {
        ...
        $(".main-wrapper").off('click', "#submit--for--staff-item-edit").on('click', "#submit--for--staff-item-edit", function() {
            ...
            var options = {
                url: "<?php echo nl2br(e(url('/o1/staff/item-save'))); ?>",
                type: "post",
                dataType: "json",
                // target: "#div2",
                // clearForm: true,
        ...
        $(".main-wrapper").off('click', ".staff--item-delete-submit").on('click', ".staff--item-delete-submit", function() {
            ...
            layer.msg('确定"删除"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "<?php echo nl2br(e(url('/o1/staff/item-delete'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        $(".main-wrapper").off('click', ".staff--item-restore-submit").on('click', ".staff--item-restore-submit", function() {
            ...
            layer.msg('确定"恢复"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "<?php echo nl2br(e(url('/o1/staff/item-restore'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        $(".main-wrapper").off('click', ".staff--item-delete-permanently-submit").on('click', ".staff--item-delete-permanently-submit", function() {
            ...
            layer.msg('确定"永久删除"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "<?php echo nl2br(e(url('/o1/staff/item-delete-permanently'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        $(".main-wrapper").off('click', ".staff--item-enable-submit").on('click', ".staff--item-enable-submit", function() {
            ...
            layer.msg('确定"启用"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "<?php echo nl2br(e(url('/o1/staff/item-enable'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        $(".main-wrapper").off('click', ".staff--item-disable-submit").on('click', ".staff--item-disable-submit", function() {
            ...
            layer.msg('确定"禁用"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "<?php echo nl2br(e(url('/o1/staff/item-disable'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        $(".main-wrapper").off('click', ".staff--item-password-reset-submit").on('click', ".staff--item-password-reset-submit", function() {
            ...
            layer.msg('确定"重置"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "<?php echo nl2br(e(url('/o1/staff/item-password-reset'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        $(".main-wrapper").off('click', ".staff--item-login-submit").on('click', ".staff--item-login-submit", function() {
            ...
            //
            $.post(
                "<?php echo nl2br(e(url('/o1/staff/item-login'))); ?>",
                {
                    _token: $('meta[name="_token"]').attr('content'),
