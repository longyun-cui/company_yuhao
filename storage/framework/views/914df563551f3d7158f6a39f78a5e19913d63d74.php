    ...
    $(function() {
        ...
        $(".main-content").on('change', 'input[name="department_type"]', function() {
            ...
            $('#select2-leader').select2({
                ajax: {
                    url: "<?php echo nl2br(e(url('/department/department_select2_leader'))); ?>",
                    dataType: 'json',
                    delay: 250,
        ...
        // 添加or编辑
        $("#edit-submit--for--department").on('click', function() {
            var options = {
                url: "<?php echo nl2br(e(url('/department/department-edit'))); ?>",
                type: "post",
                dataType: "json",
                // target: "#div2",
                success: function (data) {
                    ...
                    {
                        layer.msg(data.msg);
                        location.href = "<?php echo nl2br(e(url('/department/department-list'))); ?>";
                    }
                }
            };
        ...
        $('#select2-superior-department').select2({
            ajax: {
                url: "<?php echo nl2br(e(url('/department/department_select2_superior_department'))); ?>",
                dataType: 'json',
                delay: 250,
                data: function (params) {
                    return {
