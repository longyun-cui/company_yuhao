<script>
    $(function() {
        ...
        $(".main-wrapper").on('click', ".modal-show--for--department-item-edit", function() {
            ...
            //
            $.post(
                "<?php echo nl2br(e(url('/o1/department/item-get'))); ?>",
                {
                ...
                .done(function($response, status, jqXHR) {
                    ...
                    else
                    {
                        ...
                        if($response.data.leader)
                        {
                            ...
                            $modal.find('select[name="leader_id"]').append(new Option($response.data.leader.name, $response.data.leader_id, true, true)).trigger('change');
                        }
        ...
        $(".main-wrapper").off('click', "#submit--for--department-item-edit").on('click', "#submit--for--department-item-edit", function() {
            ...
            var options = {
                url: "<?php echo nl2br(e(url('/o1/department/item-save'))); ?>",
                type: "post",
                dataType: "json",
                // target: "#div2",
                // clearForm: true,
        ...
        $(".main-wrapper").off('click', ".department--item-delete-submit").on('click', ".department--item-delete-submit", function() {
            ...
            layer.msg('确定"删除"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "<?php echo nl2br(e(url('/o1/department/item-delete'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        $(".main-wrapper").off('click', ".department--item-restore-submit").on('click', ".department--item-restore-submit", function() {
            ...
            layer.msg('确定"恢复"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "<?php echo nl2br(e(url('/o1/department/item-restore'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        $(".main-wrapper").off('click', ".department--item-delete-permanently-submit").on('click', ".department--item-delete-permanently-submit", function() {
            ...
            layer.msg('确定"永久删除"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "<?php echo nl2br(e(url('/o1/department/item-delete-permanently'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        $(".main-wrapper").off('click', ".department--item-enable-submit").on('click', ".department--item-enable-submit", function() {
            ...
            layer.msg('确定"启用"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "<?php echo nl2br(e(url('/o1/department/item-enable'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        $(".main-wrapper").off('click', ".department--item-disable-submit").on('click', ".department--item-disable-submit", function() {
            ...
            layer.msg('确定"禁用"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "<?php echo nl2br(e(url('/o1/department/item-disable'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
