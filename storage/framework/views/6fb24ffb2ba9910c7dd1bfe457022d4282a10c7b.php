<script>
    $(function() {
        ...
        $('#select2--car--for--order--item-edit-1').on('select2:select', function(e) {
            ...
            //
            $.post(
                "<?php echo nl2br(e(url('/o1/car/item-get'))); ?>",
                {
                    _token: $('meta[name="_token"]').attr('content'),
                    operate: "item-get",
                    item_type: "car",
        ...
        $('#select2--copilot--for--order--item-edit').on('select2:select', function(e) {
            ...
            if($that_name == 'driver_id')
            {
                $modal.find('input[name=copilot_name]').val(e.params.data.driver_name);
                $modal.find('input[name=copilot_phone]').val(e.params.data.driver_phone);
            }
            else if($that_name == 'copilot_id')
            {
        ...
        $(".main-wrapper").off('click', ".order--item-delete-submit").on('click', ".order--item-delete-submit", function() {
            ...
            layer.msg('确定"删除"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "<?php echo nl2br(e(url('/o1/order/item-delete'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        $(".main-wrapper").off('click', ".order--item-restore-submit").on('click', ".order--item-restore-submit", function() {
            ...
            layer.msg('确定"恢复"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "<?php echo nl2br(e(url('/o1/order/item-restore'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        $(".main-wrapper").off('click', ".order--item-delete-permanently-submit").on('click', ".order--item-delete-permanently-submit", function() {
            ...
            layer.msg('确定"永久删除"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "<?php echo nl2br(e(url('/o1/order/item-delete-permanently'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        $(".main-wrapper").off('click', ".order--item-publish-submit").on('click', ".order--item-publish-submit", function() {
            ...
            layer.msg('确定"删除"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "<?php echo nl2br(e(url('/o1/order/item-publish'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        $(".main-wrapper").off('click', ".order--item-complete-submit").on('click', ".order--item-complete-submit", function() {
            ...
            layer.msg('确定"完成"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "<?php echo nl2br(e(url('/o1/order/item-complete'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        $(".main-wrapper").off('click', "#form-submit--for--order--item-follow-create").on('click', "#form-submit--for--order--item-follow-create", function() {
            ...
            var options = {
                url: "<?php echo nl2br(e(url('/o1/order/item-follow-save'))); ?>",
                type: "post",
                dataType: "json",
        ...
        $(".main-wrapper").off('click', "#item-submit--for--order--item-journey-create").on('click', "#item-submit--for--order--item-journey-create", function() {
            ...
            var options = {
                url: "<?php echo nl2br(e(url('/o1/order/item-journey-save'))); ?>",
                type: "post",
                dataType: "json",
                // target: "#div2",
                // clearForm: true,
        ...
        // 【工单】【财务核算】一键核对
        $(".main-wrapper").off('click', ".order--item-financial--one-click-calculation").on('click', ".order--item-financial--one-click-calculation", function() {
            var $that = $(this);
            var $datatable_wrapper = $that.closest('.datatable-wrapper');
            var $item_category = $datatable_wrapper.data('datatable-item-category');
            var $table_id = $datatable_wrapper.find('table').filter('[id][id!=""]').attr("id");
        ...
        $(".main-wrapper").off('click', "#item-submit--for--order--item-trade-create").on('click', "#item-submit--for--order--item-trade-create", function() {
            ...
            var options = {
                url: "<?php echo nl2br(e(url('/v1/operate/order/item-trade-save'))); ?>",
                type: "post",
                dataType: "json",
                // target: "#div2",
                // clearForm: true,
            ...
            layer.msg('确定"发布"么？', {
                ...
                ,yes: function(index){
                    ...
                    $.post(
                        ...
                        "<?php echo nl2br(e(url('/v1/operate/order/item-publish'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        $(".main-wrapper").on('click', ".item-complete-submit", function() {
            ...
            layer.msg('确定"完成"么？', {
                ...
                ,yes: function(index){
                    $.post(
                        "<?php echo nl2br(e(url('/item/order-complete'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        $(".main-wrapper").on('click', ".item-verify-submit", function() {
            ...
            layer.msg('确定"审核"么？', {
                ...
                ,yes: function(index){
                    $.post(
                        "<?php echo nl2br(e(url('/item/order-verify'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        $(".main-wrapper").on('click', ".item-inspect-submit", function() {
            ...
            layer.open({
                ...
                ,yes: function(index){
                    $.post(
                        "<?php echo nl2br(e(url('/item/order-inspect'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        $(".main-wrapper").on('click', '#bulk-submit--for--delivered', function() {
            ...
            layer.msg('确定"批量交付"么', {
                ...
                ,yes: function(index){
                    ...
                    $.post(
                        "<?php echo nl2br(e(url('/item/order-bulk-deliver'))); ?>",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                        ...
                        .done(function($response) {
                            ...
                            else
                            {
                                ...
                                $('input[name="bulk-id"]:checked').each(function() {
                                    ...
                                    $row.find('td[data-key=deliverer_name]').html('<a href="javascript:void(0);"><?php echo nl2br(e($me->true_name)); ?></a>');
