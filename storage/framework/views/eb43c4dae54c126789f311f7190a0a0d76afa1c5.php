                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" class="form-control date-picker-c" name="assign_date" placeholder="派车日期"
                                   value="<?php echo nl2br(e(date('Y-m-d'))); ?>"
                                   data-default="<?php echo nl2br(e(date('Y-m-d'))); ?>"
                                   readonly="readonly"
                            >
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <select class="form-control select2-box-c select2-reset" name="fee-title-for-fee" style="width:100%;">
                                ...
                                <?php if(!empty(config('wl.common-config.fee_title'))): ?>
                                    <?php $__currentLoopData = config('wl.common-config.fee_title'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value ="<?php echo nl2br(e($v)); ?>"><?php echo nl2br(e($v)); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
                            </select>
                            ...
                            <select class="form-control select2-box-c select2-reset" name="fee-title-for-deduction" style="width:100%;">
                                ...
                                <?php if(!empty(config('wl.common-config.deduction_title'))): ?>
                                    <?php $__currentLoopData = config('wl.common-config.deduction_title'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value ="<?php echo nl2br(e($v)); ?>"><?php echo nl2br(e($v)); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
                            </select>
                            ...
                            <div class="fee-title-box fine-box">
                                <select class="form-control select2-box-c select2-reset" name="fee-title-for-fine" style="width:100%;">
                                    ...
                                    <?php if(!empty(config('wl.common-config.fine_title'))): ?>
                                        <?php $__currentLoopData = config('wl.common-config.fine_title'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value ="<?php echo nl2br(e($v)); ?>"><?php echo nl2br(e($v)); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php endif; ?>
                                </select>
