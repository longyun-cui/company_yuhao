<script>
    $(function() {
        ...
        // 【车辆】导入-显示
        $(".main-wrapper").on('click', ".modal-show--for--fee-import", function() {
            var $that = $(this);
        ...
        // 【车辆】导入-提交
        $(".main-wrapper").on('click', "#submit--for--fee--import--by-excel", function() {
            var $that = $(this);

            var $table_id = $that.data('datatable-list-id');
            var $table = $('#'+$table_id);

            var $modal_id = 'modal--for--fee--import--by-excel';
            var $modal = $("#"+$modal_id);

            var $form_id = 'form--for--fee--import--by-excel';
            var $form = $("#"+$form_id);
            ...
            var options = {
                url: "<?php echo nl2br(e(url('/o1/fee/import--save'))); ?>",
                type: "post",
                dataType: "json",
                // target: "#div2",
                // clearForm: true,
        ...
        $(".main-wrapper").on('click', "#submit--for--fee--item-edit", function() {
            ...
            var options = {
                url: "<?php echo nl2br(e(url('/o1/fee/item-save'))); ?>",
                type: "post",
                dataType: "json",
                // target: "#div2",
                // clearForm: true,
        ...
        $(".main-wrapper").off('click', ".fee--item-delete-submit").on('click', ".fee--item-delete-submit", function() {
            ...
            layer.msg('确定"删除"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "<?php echo nl2br(e(url('/o1/fee/item-delete'))); ?>",
                        {
        ...
        $(".main-wrapper").off('click', "#item-submit--for--fee--item-finance-bookkeeping").on('click', "#item-submit--for--fee--item-finance-bookkeeping", function() {
            ...
            var options = {
                url: "<?php echo nl2br(e(url('/o1/fee/item-finance-bookkeeping'))); ?>",
                type: "post",
                dataType: "json",
                // target: "#div2",
                // clearForm: true,
