<script>
    $(function() {
        ...
        $('#select2-superior').select2({
            ajax: {
                url: "<?php echo nl2br(e(url('/user/user_select2_superior'))); ?>",
                dataType: 'json',
                delay: 250,
        ...
        // 【选择用户类型】
        $("#form-for-driver-edit").on('change', "input[name=user_type]", function() {
        ...
        $('#select2-department-district').select2({
            ajax: {
                url: "<?php echo nl2br(e(url('/user/user_select2_department?type=district'))); ?>",
                dataType: 'json',
                delay: 250,
                data: function (params) {
                    return {
        ...
        $("#select2-department-district").on("select2:select",function(){
            ...
            if($id > 0)
            {
                ...
                $('#select2-department-group').select2({
                    ajax: {
                        url: "<?php echo nl2br(e(url('/user/user_select2_department?type=group'))); ?>",
                        dataType: 'json',
                        delay: 250,
                        data: function (params) {
                            return {
            ...
            ajax: {
                ...
                data: function (params) {
                    return {
                        keyword: params.term, // search term
                        page: params.page,
                        <?php if(in_array($me->user_type,[41,81])): ?>
                        superior_id: <?php echo nl2br(e(isset($me->department_district_id) ? $me->department_district_id : 0)); ?>

                        <?php else: ?>
                        superior_id: <?php echo nl2br(e(isset($data->department_district_id) ? $data->department_district_id : 0)); ?>
