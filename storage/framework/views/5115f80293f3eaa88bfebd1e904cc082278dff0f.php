...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <?php if(in_array($me->staff_category,[0,1,9])): ?>
            <li class="treeview">
            ...
            <?php if(in_array($me->staff_category,[0,1,9,81])): ?>
            <li class="treeview">
                <a class="tab-control datatable-control"
                   data-type="create"
                   data-unique="y"
            ...
            <?php if(in_array($me->staff_category,[0,1,9,81])): ?>
                <li class="treeview">
                    <a class="tab-control datatable-control"
                       ...
                       data-datatable-type="create"
                       data-datatable-unique="y"
                       data-datatable-id="datatable--car--statistic--task-recent"
                       data-datatable-target="car--statistic--task-recent"
            ...
            <?php if(in_array($me->staff_category,[0,1,9,31,81])): ?>
            <li class="treeview _none-">
                <a class="tab-control datatable-control"
                   data-type="create"
                   data-unique="y"
            ...
            <?php if(in_array($me->staff_category,[0,1,9,31,71])): ?>
                <li class="treeview _none-">
                    <a class="tab-control datatable-control"
                       data-type="create"
                       data-unique="y"
            ...
            <?php if(in_array($me->staff_position,[0,1,9,11,41])): ?>
            <li class="treeview _none">
                <a class="tab-control datatable-control"
                   data-type="create"
                   data-unique="y"
            ...
            <?php if(in_array($me->staff_position,[0,1,9,11,81,84,88])): ?>
            <?php endif; ?>
