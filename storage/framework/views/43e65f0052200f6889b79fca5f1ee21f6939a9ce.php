<script>
    function Datatable_Statistic__Project__Task_Recent($tableId)
    {
        let $that = $($tableId);
...
//                "scrollY": true,
            ...
            "showRefresh": true,
            "ajax": {
                'url': "<?php echo nl2br(e(url('/o1/project/statistic/statistic-task-recent'))); ?>",
                "type": 'POST',
                "dataType" : 'json',
                "data": function (d) {
                    ...
                    d.time_type = $tableSearch.find('input[name="project--statistic--task-recent-time-type"]').val();
                    d.time_month = $tableSearch.find('input[name="project--statistic--task-recent-month"]').val();
                    d.time_date = $tableSearch.find('input[name="project--statistic--task-recent-date"]').val();
                    d.date_start = $tableSearch.find('input[name="project--statistic--task-recent-start"]').val();
                    d.date_ended = $tableSearch.find('input[name="project--statistic--task-recent-ended"]').val();
                    d.project = $tableSearch.find('input[name="statistic-caller--project"]').val();
                    d.team = $tableSearch.find('select[name="project--statistic--task-recent--team"]').val();
                    d.group = $tableSearch.find('select[name="project--statistic--task-recent--group"]').val();
