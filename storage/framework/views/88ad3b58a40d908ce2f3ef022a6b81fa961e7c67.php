    ...
    $(function() {
        ...
        $(".main-content").on('change', 'input[name="company_type"]', function() {
            ...
            $('#select2-leader').select2({
                ajax: {
                    url: "<?php echo nl2br(e(url('/company/company_select2_leader'))); ?>",
                    dataType: 'json',
                    delay: 250,
        ...
        $("#edit-submit--for--company").on('click', function() {
            var options = {
                url: "<?php echo nl2br(e(url('/company/company-edit'))); ?>",
                type: "post",
                dataType: "json",
                // target: "#div2",
                success: function (data) {
                    ...
                    {
                        layer.msg(data.msg);
                        location.href = "<?php echo nl2br(e(url('/company/company-list'))); ?>";
                    }
                }
            };
        ...
        $('#select2-superior-company').select2({
            ajax: {
                url: "<?php echo nl2br(e(url('/company/company_select2_superior_company'))); ?>",
                dataType: 'json',
                delay: 250,
                data: function (params) {
                    return {
