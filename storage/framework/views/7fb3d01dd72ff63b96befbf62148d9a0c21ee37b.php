<script>
    ...
    $(function() {
        ...
        // $(".main-content").on('select2', ".select2-car", function() {
            ajax: {
                url: "<?php echo nl2br(e(url('/v1/operate/select2/select2-car'))); ?>",
                type: 'post',
                dataType: 'json',
                delay: 250,
        ...
        $('.select2--company').each(function() {
            ...
            $this.select2({
                ajax: {
                    url: "<?php echo nl2br(e(url('/o1/select2/select2--company'))); ?>",
                    type: 'post',
                    dataType: 'json',
                    delay: 250,
                    data: function (params) {
        ...
        $('.select2--department').each(function() {
            ...
            $this.select2({
                ajax: {
                    url: "<?php echo nl2br(e(url('/o1/select2/select2--department'))); ?>",
                    type: 'post',
                    dataType: 'json',
                    delay: 250,
                    data: function (params) {
        ...
        $('.select2--team').each(function() {
            ...
            $this.select2({
                ajax: {
                    url: "<?php echo nl2br(e(url('/o1/select2/select2--team'))); ?>",
                    type: 'post',
                    dataType: 'json',
                    delay: 250,
                    data: function (params) {
        ...
        $('.select2--staff').each(function() {
            ...
            $this.select2({
                ajax: {
                    url: "<?php echo nl2br(e(url('/o1/select2/select2--staff'))); ?>",
                    type: 'post',
                    dataType: 'json',
                    delay: 250,
                    data: function (params) {
        ...
        $('.select2--motorcade').each(function() {
            ...
            $this.select2({
                ajax: {
                    url: "<?php echo nl2br(e(url('/o1/select2/select2--motorcade'))); ?>",
                    type: 'post',
                    dataType: 'json',
                    delay: 250,
                    data: function (params) {
        ...
        $('.select2--car').each(function() {
            ...
            $this.select2({
                ajax: {
                    url: "<?php echo nl2br(e(url('/o1/select2/select2--car'))); ?>",
                    type: 'post',
                    dataType: 'json',
                    delay: 250,
                    data: function (params) {
        ...
        $('.select2--driver').each(function() {
            ...
            $this.select2({
                ajax: {
                    url: "<?php echo nl2br(e(url('/o1/select2/select2--driver'))); ?>",
                    type: 'post',
                    dataType: 'json',
                    delay: 250,
                    data: function (params) {
        ...
        $('.select2--client').each(function() {
            ...
            $this.select2({
                ajax: {
                    url: "<?php echo nl2br(e(url('/o1/select2/select2--client'))); ?>",
                    type: 'post',
                    dataType: 'json',
                    delay: 250,
                    data: function (params) {
        ...
        $('.select2--project').each(function() {
            ...
            $this.select2({
                ajax: {
                    url: "<?php echo nl2br(e(url('/o1/select2/select2--project'))); ?>",
                    type: 'post',
                    dataType: 'json',
                    delay: 250,
                    data: function (params) {
    ...
    function select2_client_init(selector,$default)
    {
        ...
        $element.select2({
            ajax: {
                url: "<?php echo nl2br(e(url('/v1/operate/select2/select2_client'))); ?>",
                type: 'post',
                dataType: 'json',
                delay: 250,
                data: function (params) {
    ...
    function select2_project_init(selector,$default)
    {
        ...
        $element.select2({
            ajax: {
                url: "<?php echo nl2br(e(url('/v1/operate/select2/select2_project'))); ?>",
                type: 'post',
                dataType: 'json',
                delay: 250,
                data: function (params) {
    ...
    function select2_location_district_init(selector,$default)
    {
        ...
        $element.select2({
            ajax: {
                url: "<?php echo nl2br(e(url('/v1/operate/select2/select2_location' ))); ?>",
                type: 'post',
                dataType: 'json',
                delay: 250,
                data: function (params) {
        ...
        $.post(
            ...
            function(result){
                if(result.result != 'access')
                {
                    ...
                    setTimeout(function(){
                        location.href = "<?php echo nl2br(e(url('/logout_without_token'))); ?>";
                    }, 600);
                }
            }
        );
    ...
    function select2_department_init(selector,$default)
    {
        ...
        $element.select2({
            ajax: {
                url: "<?php echo nl2br(e(url('/v1/operate/select2/select2_department'))); ?>",
                type: 'post',
                dataType: 'json',
                delay: 250,
                data: function (params) {
