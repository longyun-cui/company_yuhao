    ...
    $(function() {
        ...
        $("#form-for-staff-edit").on('change', "input[name=staff_category]", function() {
            ...
            $('#staff-edit-select2-department').select2({
                ajax: {
                    url: "<?php echo nl2br(e(url('/v1/operate/select2/select2-department'))); ?>",
                    type: 'post',
                    dataType: 'json',
                    delay: 250,
                    data: function (params) {
        ...
        $('#staff-edit-select2-department').on('select2:select', function(e) {
            ...
            $('#staff-edit-select2-team').select2({
                ajax: {
                    url: "<?php echo nl2br(e(url('/v1/operate/select2/select2-team'))); ?>",
                    type: 'post',
                    dataType: 'json',
                    delay: 250,
                    data: function (params) {
        ...
        $('#staff-edit-select2-team').select2({
            ajax: {
                url: "<?php echo nl2br(e(url('/v1/operate/select2/select2-team1'))); ?>",
                type: 'post',
                dataType: 'json',
                delay: 250,
                data: function (params) {
