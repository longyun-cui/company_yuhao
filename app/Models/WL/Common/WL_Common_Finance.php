...
class WL_Common_Finance extends Model
{
    use SoftDeletes;
    //
    protected $table = "wl__common__financial__record";
    protected $fillable = [
        ...
        'finance_active', 'finance_status', 'finance_result',
        'finance_category', 'finance_type', 'finance_group',
...
//    }
    ...
    function fee_er()
    {
        return $this->belongsTo('App\Models\WL\Common\WL_Common_Fee','fee_id','id');
    }
