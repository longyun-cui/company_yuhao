...
//        }
        ...
        $unSpecified = ['id'=>0,'text'=>'选择公司'];
        array_unshift($list,$unSpecified);
//        $unSpecified = ['id'=>-1,'text'=>'[全部公司]'];
//        array_unshift($list,$unSpecified);
    ...
    public function o1__select2__department($post_data)
    {
        ...
        $unSpecified = ['id'=>0,'text'=>'选择部门'];
        array_unshift($list,$unSpecified);
//        $unSpecified = ['id'=>-1,'text'=>'[全部部门]'];
//        array_unshift($list,$unSpecified);
    ...
    public function o1__select2__team($post_data)
    {
        ...
        $unSpecified = ['id'=>0,'text'=>'选择团队'];
        array_unshift($list,$unSpecified);
//        $unSpecified = ['id'=>-1,'text'=>'[全部团队]'];
//        array_unshift($list,$unSpecified);
    ...
    public function o1__select2__staff($post_data)
    {
        ...
        $unSpecified = ['id'=>0,'text'=>'选择员工'];
        array_unshift($list,$unSpecified);
//        $unSpecified = ['id'=>-1,'text'=>'[全部员工]'];
//        array_unshift($list,$unSpecified);
    ...
    public function o1__select2__motorcade($post_data)
    {
        ...
        $unSpecified = ['id'=>0,'text'=>'选择车队'];
        array_unshift($list,$unSpecified);
//        $unSpecified = ['id'=>-1,'text'=>'[全部车队]'];
//        array_unshift($list,$unSpecified);
...
//        array_unshift($list,$unSpecified);
    ...
    public function o1__select2__client($post_data)
    {
        ...
        $unSpecified = ['id'=>0,'text'=>'选择客户'];
        array_unshift($list,$unSpecified);
//        $unSpecified = ['id'=>-1,'text'=>'[全部客户]'];
//        array_unshift($list,$unSpecified);
    ...
    public function o1__select2__project($post_data)
    {
        ...
        $query = WL_Common_Project::select(['id','name as text','transport_route','transport_departure_place','transport_destination_place','transport_distance','transport_time_limitation','freight_amount','invoice_amount','invoice_point'])
            ->where('item_status',1);
        ...
        $unSpecified = ['id'=>0,'text'=>'选择项目'];
        array_unshift($list,$unSpecified);
//        $unSpecified = ['id'=>-1,'text'=>'[全部项目]'];
//        array_unshift($list,$unSpecified);
