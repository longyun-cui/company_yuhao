...
<head>
    ...
    <link rel="shortcut icon" type="image/ico" href="{{ env('FAVICON_WL_STAFF') }}">
    <link rel="shortcut icon" type="image/png" href="{{ env('FAVICON_WL_STAFF') }}">
    <link rel="icon" sizes="16x16 32x32 64x64" href="{{ env('FAVICON_WL_STAFF') }}">
    <link rel="icon" type="image/png" sizes="196x196" href="{{ env('FAVICON_WL_STAFF') }}">
    ...
    {{--layout-style--}}
    @include(env('TEMPLATE_WL_STAFF').'layout.layout-style')
...
<div class="wrapper main-wrapper">
    ...
    {{--main-header--}}
    @include(env('TEMPLATE_WL_STAFF').'layout.main-header')

    {{--main-sidebar--}}
    @include(env('TEMPLATE_WL_STAFF').'layout.main-sidebar')

    {{--main-content--}}
    @include(env('TEMPLATE_WL_STAFF').'layout.main-content')

    {{--main-footer--}}
{{--    @include(env('TEMPLATE_WL_STAFF').'layout.main-footer')--}}

    {{--control-sidebar--}}
    @include(env('TEMPLATE_WL_STAFF').'layout.control-sidebar')
...
{{--layout-script--}}
@include(env('TEMPLATE_WL_STAFF').'layout.layout-script-for-tab')
@include(env('TEMPLATE_WL_STAFF').'layout.layout-script-for-datatable')
@include(env('TEMPLATE_WL_STAFF').'layout.layout-script-for-item-edit')
@include(env('TEMPLATE_WL_STAFF').'layout.layout-script')
