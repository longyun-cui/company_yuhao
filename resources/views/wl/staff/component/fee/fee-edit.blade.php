{{--编辑-工单--}}
<div class="modal fade modal-main-body modal-wrapper" id="modal-for-fee-edit">
    <div class="modal-content col-md-8 col-md-offset-2 margin-top-24px margin-bottom-64px bg-white">
        <div class="box- box-info- form-container">
            ...
            <form action="" method="post" class="form-horizontal form-bordered" id="form-for-fee-edit">
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8 ">
                        <select class="form-control select2-box-c" name="client_id" id="fee-edit-select2-client" style="width:100%;">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8 ">
                        <select class="form-control select2-box-c" name="project_id" id="fee-edit-select2-project" style="width:100%;">
                ...
                <div class="form-group" >
                    ...
                    <div class="col-md-8 ">
                        <div class="col-sm-6 col-md-6 padding-0">
                            <input type="text" class="form-control" name="transport_mileage" placeholder="里程" value="0" data-default="">
                        </div>
                        <div class="col-sm-6 col-md-6 padding-0">
                ...
                <div class="form-group internal-car">
                    ...
                    <div class="col-md-8 ">
                        <div class="col-sm-6 col-md-6 padding-0">
                            <select class="form-control select2-reset fee-edit-select2-car" name="car_id" id="fee-edit-select2-car" data-car-type="1">
                                <option value="0">选择车辆</option>
                            </select>
                        </div>
                        <div class="col-sm-6 col-md-6 padding-0">
                            <select class="form-control select2-reset fee-edit-select2-car" name="trailer_id" id="fee-edit-select2-trailer" data-car-type="21">
                ...
                <div class="form-group internal-car">
                    ...
                    <div class="col-md-8 ">
                        <div class="col-sm-6 col-md-6 padding-0">
                            <select class="form-control select2-reset fee-edit-select2-driver" name="driver_id" id="fee-edit-select2-driver">
                                <option value="0">选择主驾</option>
                            </select>
                        </div>
                        <div class="col-sm-6 col-md-6 padding-0">
                            <select class="form-control select2-reset fee-edit-select2-driver" name="copilot_id" id="fee-edit-select2-copilot">
                ...
                {{--外请司机--}}
                <div class="form-group external-car" style="display:none;">
                    <label class="control-label col-md-3"><sup class="text-red">*</sup> 外请司机</label>
                    <div class="col-md-8 ">
                        <div class="col-sm-6 col-md-6 padding-0" style="width:50%;">
