<div class="row datatable-body datatable-wrapper statistic-driver-by-daily-clone" data-datatable-item-category="statistic-driver-by-daily">
    ...
    <div class="col-md-12 datatable-search-row  datatable-search-box">
        ...
        <div class="pull-right">
            ...
            <input type="text" class="search-filter form-filter filter-keyup month_picker" name="statistic-driver-by-daily-month" placeholder="选择月份" readonly="readonly" value="{{ date('Y-m') }}" data-default="{{ date('Y-m') }}" />
