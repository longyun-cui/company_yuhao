{{--编辑-部门--}}
<div class="modal fade modal-main-body modal-wrapper" id="modal--for--motorcade-item-edit">
    <div class="modal-content col-md-8 col-md-offset-2 margin-top-24px margin-bottom-64px bg-white">
        <div class="box- box-info- form-container">

            <div class="box-header with-border margin-top-16px">
                <h3 class="box-title">添加车队</h3>
                <div class="box-tools pull-right">
                </div>
            </div>


            <form action="" method="post" class="form-horizontal form-bordered" id="form--for--motorcade-item-edit">
            <div class="box-body">
                ...
                <input readonly type="hidden" class="form-control" name="operate[item_type]" value="motorcade" data-default="motorcade">
                ...
                <div class="form-group form-category" style="height:70px;">
                    ...
                    <div class="col-md-8">
                        <div class="btn-group">
                            ...
                            <button type="button" class="btn radio-btn radio-motorcade-category">
                                <span class="radio">
                                    <label>
                                        <input type="radio" name="motorcade_category" value="1" checked="checked"> 车队
                                    </label>
                                </span>
                            </button>
                            @endif
                            ...
                            <button type="button" class="btn radio-btn radio-motorcade-category">
                                <span class="radio">
                                    <label>
                                        <input type="radio" name="motorcade_category" value="21"> 渠道
                                    </label>
                                </span>
                            </button>
                            @endif
                            ...
                            <button type="button" class="btn radio-btn radio-motorcade-category">
                                <span class="radio">
                                    <label>
                                        <input type="radio" name="motorcade_category" value="31"> 商务
                                    </label>
                                </span>
                            </button>
                            @endif
                ...
                <div class="form-group select2-superior-box _none" style="height:70px;">
                    ...
                    <div class="col-md-8 ">
                        <select class="form-control select2-box" name="superior_motorcade_id" id="select2-superior-motorcade" style="width:100%;">
            ...
            <div class="box-footer">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <button type="button" class="btn btn-success edit-submit" id="submit--for--motorcade-item-edit">
