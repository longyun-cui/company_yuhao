<div class="row datatable-body datatable-wrapper car--statistic--task-recent--clone" data-datatable-item-category="car--statistic--task-recent">
    ...
    <div class="col-md-12 datatable-search-row  datatable-search-box">
        ...
        <div class="pull-right">
            ...
            <input type="hidden" name="car--statistic--task-recent-time-type" class="time-type" value="" readonly>
