<div class="row datatable-body datatable-wrapper project--statistic--task-recent--clone" data-datatable-item-category="project--statistic--task-recent">
    ...
    <div class="col-md-12 datatable-search-row  datatable-search-box">
        ...
        <div class="pull-right">
            ...
            <input type="hidden" name="project--statistic--task-recent-time-type" class="time-type" value="" readonly>

{{--            @if(in_array($me->staff_category,[0,1,9,61]))--}}
{{--            <select class="search-filter form-filter filter-xl select2-box-c" name="project--statistic--task-recent--motorcade">--}}
