<script>
    var Datatable__for__Order__Item__Operation_Record_List = function ($datatable_id,$id) {
        var datatableAjax__order_item_operation_record = function ($datatable_id,$id) {

            var dt__order__item__operation_record = $($datatable_id);
            if($.fn.DataTable.isDataTable(dt__order__item__operation_record))
            {
                // 已经初始化
                console.log($datatable_id + ' // 已经初始化');
                $(dt__order__item__operation_record).DataTable().destroy();
                dt__order__item__operation_record.DataTable().destroy();
            }
            else
            {
            ...
            var ajax_datatable__order__operation_record = dt__order__item__operation_record.DataTable({
                "retrieve": true,
                "destroy": true,
