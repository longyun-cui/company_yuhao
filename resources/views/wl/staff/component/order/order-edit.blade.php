        ...
        <div class="box- box-info- form-container">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8 ">
                        <select class="form-control select2-box-c" name="client_id" id="order-edit-select2-client" style="width:100%;">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8 ">
                        <select class="form-control select2-box-c" name="project_id" id="order-edit-select2-project" style="width:100%;">
                ...
                <div class="form-group internal-car">
                    ...
                    <div class="col-md-8 ">
                        <div class="col-sm-6 col-md-6 padding-0">
                            <select class="form-control select2-reset order-edit-select2-car" name="car_id" id="order-edit-select2-car" data-car-type="1">
                                <option value="0">选择车辆</option>
                            </select>
                        </div>
                        <div class="col-sm-6 col-md-6 padding-0">
                            <select class="form-control select2-reset order-edit-select2-car" name="trailer_id" id="order-edit-select2-trailer" data-car-type="21">
                ...
                <div class="form-group internal-car">
                    ...
                    <div class="col-md-8 ">
                        <div class="col-sm-6 col-md-6 padding-0">
                            <select class="form-control select2-reset order-edit-select2-driver" name="driver_id" id="order-edit-select2-driver">
                                <option value="0">选择主驾</option>
                            </select>
                        </div>
                        <div class="col-sm-6 col-md-6 padding-0">
                            <select class="form-control select2-reset order-edit-select2-driver" name="copilot_id" id="order-edit-select2-copilot">
