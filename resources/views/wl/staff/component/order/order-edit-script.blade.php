<script>
    ...
    $(function() {
        ...
        // 【选择车辆所属】
        $("#form-for-order-edit").on('click', "input[name=car_owner_type]", function() {
            // checkbox
//            if($(this).is(':checked'))
//            {
//                $('.time-show').show();
...
//            }
        ...
        $('#order-edit-select2-project').on('select2:select', function(e) {
            ...
            $('input[name=transport_mileage]').val(e.params.data.transport_mileage);
...
//                    });
        ...
        $('.order-edit-select2-driver').on('select2:select', function(e) {
            ...
            {
                $('input[name=driver_name]').val(e.params.data.text);
                $('input[name=driver_phone]').val(e.params.data.driver_phone);
            }
            else if($that_name == 'copilot_id')
            {
                $('input[name=copilot_name]').val(e.params.data.text);
                $('input[name=copilot_phone]').val(e.params.data.driver_phone);
            }
        });
