<script>
    $(function() {
        ...
        // 【部门管理】编辑-显示-编辑
        $(".main-content").on('click', ".team-edit-show", function() {
            var $that = $(this);
            ...
            $.post(
                ...
                .done(function($response, status, jqXHR) {
                    ...
                    else
                    {
                        ...
                        $modal.find('input[name="team_type"][value="'+$response.data.team_type+'"]').attr('checked', 'checked');
                        console.log($response.data.team_type);
