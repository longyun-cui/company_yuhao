        ...
        $("#edit-item-submit").on('click', function() {
            var options = {
                ...
                success: function (data) {
                    ...
                    {
                        layer.msg(data.msg);
                        location.href = "{{ url('/team/team-list') }}";
                    }
                }
            };
        ...
        $('#team-edit-select2-department').select2({
            ajax: {
                ...
                data: function (params) {
                    return {
                        _token: $('meta[name="_token"]').attr('content'),
                        // department_category: this.parents('form').find('input[name="team_category"]:checked').val(),
                        department_category: $('#form-for-team-edit').find('input[name="team_category"]:checked').val(),
                        keyword: params.term, // search term
                        page: params.page
                    };
                },
