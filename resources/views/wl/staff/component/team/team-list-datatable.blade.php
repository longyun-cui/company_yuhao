<script>
    function Datatable_for_Team_List($tableId)
    {
...
//                "scrollY": true,
            "scrollCollapse": true,
            "ajax": {
                'url': "{{ url('/v1/operate/team/datatable-list-query') }}",
                "type": 'POST',
                "dataType" : 'json',
                "data": function (d) {
...
//                            return data;
                        ...
                        {
                            return '<small class="btn-xs bg-black"><i></i></small>';
                        }
...
//                            return $year+'-'+$month+'-'+$day+'&nbsp;&nbsp;'+$hour+':'+$minute+':'+$second;
                ...
                },
                {
                    ...
                    render: function(data, type, row, meta) {
                        ...
                        var html =
                            // '<a class="btn btn-xs item-edit-link" data-id="'+data+'">编辑</a>'+
                            '<a class="btn btn-xs team-edit-show" data-id="'+data+'">编辑</a>'+
                            $html_able+
                            $html_delete+
                            // $html_record+
            ...
            "drawCallback": function (settings) {
                ...
                console.log('team-list-datatable-execute');
