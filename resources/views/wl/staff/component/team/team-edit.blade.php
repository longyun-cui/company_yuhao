{{--编辑-部门--}}
<div class="modal fade modal-main-body modal-wrapper" id="modal-for-team-edit">
    <div class="modal-content col-md-8 col-md-offset-2 margin-top-24px margin-bottom-64px bg-white">
        <div class="box- box-info- form-container">
            ...
            <form action="" method="post" class="form-horizontal form-bordered" id="form-for-team-edit">
            <div class="box-body">
                ...
                {{--层级--}}
                <div class="form-group form-category" style="height:70px;">
                    <label class="control-label col-md-2"><sup class="text-red">*</sup> 层级</label>
                    <div class="col-md-8">
                        <div class="btn-group">
                ...
                <div class="form-group" style="height:70px;">
                    ...
                    <div class="col-md-8 ">
                        <select class="form-control select2-box" name="department_id" id="team-edit-select2-department">
                ...
                <div class="form-group" style="height:70px;">
                    ...
                    <div class="col-md-8 ">
                        <select class="form-control select2-box" name="leader_id" id="team-edit-select2-leader" data-type="manager">
            ...
            <div class="box-footer">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <button type="button" class="btn btn-success edit-submit" id="edit-submit-for-team">
