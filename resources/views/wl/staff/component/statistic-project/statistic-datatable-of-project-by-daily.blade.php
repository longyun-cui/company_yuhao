<script>
    ...
    function Datatable_Statistic_Project_by_Daily($tableId, $eChartId)
    {
        ...
        $($tableId).DataTable({
            ...
            "orderCellsTop": true,
            "ajax": {
                'url': "{{ url('/v1/operate/statistic/statistic-project-by-daily') }}",
                "type": 'POST',
                "dataType" : 'json',
                "data": function (d) {
                    d._token = $('meta[name="_token"]').attr('content');
                    d.id = $tableSearch.find('input[name="statistic-project-daily-id"]').val();
                    d.name = $tableSearch.find('input[name="statistic-project-daily-name"]').val();
                    d.title = $tableSearch.find('input[name="statistic-project-daily-title"]').val();
                    d.keyword = $tableSearch.find('input[name="statistic-project-daily-keyword"]').val();
                    d.status = $tableSearch.find('select[name="statistic-project-daily-status"]').val();
                    d.time_type = $tableSearch.find('input[name="statistic-project-daily-time-type"]').val();
                    d.time_month = $tableSearch.find('input[name="statistic-project-daily-month"]').val();
                    d.time_date = $tableSearch.find('input[name="statistic-project-daily-date"]').val();
                    d.date_start = $tableSearch.find('input[name="statistic-project-daily-start"]').val();
                    d.date_ended = $tableSearch.find('input[name="statistic-project-daily-ended"]').val();
                },
            },
            // "fixedColumns": {
