<div class="row datatable-body datatable-wrapper finance-list-clone" data-datatable-item-category="finance" data-item-name="费用">
    ...
    <div class="col-md-12 datatable-search-row  datatable-search-box">
        ...
        <div class="pull-right">
            ...
            <select class="search-filter form-filter filter-md select2-box-c" name="finance-transaction-type">
                <option value="-1">全部类型</option>
                <option value="1">收入</option>
                <option value="99">支出</option>
            </select>
