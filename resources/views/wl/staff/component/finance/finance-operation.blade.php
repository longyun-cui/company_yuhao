{{--工单详情--}}
<div class="modal fade modal-wrapper" id="modal-for-finance-item-order-detail">
...
{{--添加-费用记录--}}
<div class="modal fade modal-wrapper" id="modal-for-finance-financial-create">
    <div class="col-md-6 col-md-offset-3 margin-top-64px margin-bottom-64px bg-white">
        ...
        <div class="box- box-info- form-container">
            ...
            <form action="" method="post" class="form-horizontal form-bordered " id="form-for-finance-financial-create">
                <div class="box-body">
                    ...
                    <input readonly type="hidden" class="form-control" name="operate[item_type]" value="financial" data-default="finance">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 ">
                            <input type="text" class="form-control" name="transaction-amount" placeholder="请输入金额" value="">
                        </div>
                    </div>
                    {{--支付方式--}}
                    <div class="form-group">
                    ...
                    <div class="form-group income-show-">
                        ...
                        <div class="col-md-8 ">
                            <input type="text" class="form-control search-input" id="keyword" name="transaction-account-from" placeholder="付款账号" value="" list="_finance_account_from" autocomplete="on">
                        </div>
                    </div>
                    <datalist id="_finance_account_from">
                    </datalist>
                    {{--收款账号--}}
                    <div class="form-group income-show-">
                    ...
                    <datalist id="_finance_account_to">
                    </datalist>
                    {{--交易单号--}}
                    <div class="form-group  _none">
            ...
            <div class="box-footer">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <button type="button" class="btn btn-success" id="item-submit-for-finance-financial-create"><i class="fa fa-check"></i> 提交</button>
                        <button type="button" class="btn btn-default modal-cancel">取消</button>
                    </div>
                </div>
            </div>
