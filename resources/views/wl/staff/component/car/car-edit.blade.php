{{--编辑-部门--}}
<div class="modal fade modal-main-body modal-wrapper" id="modal-for-car-edit">
    <div class="modal-content col-md-8 col-md-offset-2 margin-top-24px margin-bottom-64px bg-white">
        <div class="box- box-info- form-container modal-body">
            ...
            <form action="" method="post" class="form-horizontal form-bordered" id="form-for-car-edit">
            <div class="box-body">
                ...
                <input readonly type="hidden" class="form-control" name="operate[item_type]" value="car" data-default="department">
                ...
                <div class="form-group form-category">
                    ...
                    <div class="col-md-8">
                        <div class="btn-group">
                            ...
                            <button type="button" class="btn radio-btn radio-car-category">
                                <span class="radio">
                                    <label>
                                        <input type="radio" name="car_category" value="1"> 车辆
                                    </label>
                                </span>
                            </button>
                            @endif
                            ...
                            <button type="button" class="btn radio-btn radio-car-category">
                                <span class="radio">
                                    <label>
                                        <input type="radio" name="car_category" value="41"> 车挂
                                    </label>
                                </span>
                            </button>
                            @endif
...
{{--                </div>--}}
                <div class="form-group">
                    ...
                    <div class="col-md-8 ">
                        <input type="text" class="form-control" name="api_carNo" placeholder="API坐席ID，没有添0" value="">
                    </div>
                </div>
                {{--描述--}}
            ...
            <div class="box-footer">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <button type="button" class="btn btn-success edit-submit" id="edit-submit-for-car">
