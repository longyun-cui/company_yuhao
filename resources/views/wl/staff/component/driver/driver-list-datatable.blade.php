<script>
    function Datatable_for_Driver_List($tableId)
    {
...
//                "scrollY": true,
            "scrollCollapse": true,
            "ajax": {
                'url': "{{ url('/v1/operate/driver/datatable-list-query') }}",
                "type": 'POST',
                "dataType" : 'json',
                "data": function (d) {
...
//                            return $year+'-'+$month+'-'+$day+'&nbsp;&nbsp;'+$hour+':'+$minute+':'+$second;
                ...
                },
                {
                    ...
                    render: function(data, type, row, meta) {
                        ...
                        var html =
                            '<a class="btn btn-xs driver-edit-show" data-id="'+data+'">编辑</a>'+
                            $html_able+
                            $html_delete+
                            // $html_record+
            ...
            "drawCallback": function (settings) {
                ...
                console.log('driver-list-datatable-execute');
