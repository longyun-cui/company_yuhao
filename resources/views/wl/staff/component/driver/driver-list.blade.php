    ...
    <div class="col-md-12 datatable-search-row  datatable-search-box">
        ...
        <div class=" pull-left">
            ...
            <button type="button" onclick="" class="btn btn-filter btn-success- item-create-modal-show"
                    data-form-id="form-for-driver-edit"
                    data-modal-id="modal-for-driver-edit"
                    data-title="添加司机"
            >
        ...
        <div class="pull-right">
            ...
            <input type="text" class="search-filter form-filter filter-keyup" name="driver-username" placeholder="名称" />

            @if(in_array($me->user_type,[0,1,9,11]))
            <select class="search-filter form-filter filter-md select2-box-c" name="driver-user-type">
...
{{--            @if(in_array($me->user_type,[0,1,9,11]))--}}
{{--            <select class="search-filter form-filter filter-md select2-box-c" name="driver-department-district">--}}
...
{{--            @endif--}}
            ...
            <select class="search-filter form-filter filter-md select2-box-c" name="driver-user-status">
    ...
    <div class="col-md-12 datatable-body">
        <div class="tableArea table-driver-list">
