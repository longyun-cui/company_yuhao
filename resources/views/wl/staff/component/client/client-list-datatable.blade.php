<script>
    function Datatable_for_Client_List($tableId)
    {
                ...
                },
                {
                    ...
                    render: function(data, type, row, meta) {
                        ...
                        @if(in_array($me->user_type,[0,1,9,11]))
                            $html_login = '<a class="btn btn-xs item-login-submit" data-id="'+data+'">登录</a>';
                        @endif
                        ...
                        var html =
                            ...
                            '<a class="btn btn-xs client-edit-show" data-id="'+data+'">编辑</a>'+
